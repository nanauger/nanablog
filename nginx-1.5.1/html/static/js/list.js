...
function addShoppingCart(productId,rid) {
    var productNumber=$("#text_box").val();
    var href=$('.text_href').val(); 
    if(productNumber>0){
		  	var temp_form = document.createElement("form");      
             temp_form .action = href+"/shopping/add.html";
             temp_form.target = "_blank";
			 temp_form.method = "get";
			 temp_form.style.display = "none";
...
function gotoBuy(productId){
	...
	var href=$('.text_href').val();           		
   	var temp_form = document.createElement("form");      
    temp_form .action = href+"/shopping/gotoOrderDirect.html";
    temp_form.method = "get";
	temp_form.style.display = "none";
	var opt = document.createElement("textarea");
	opt.name = 'productId';
	...
	var opt2 = document.createElement("textarea");
	opt2.name = 'rid';
	var formatTimeS = new Date().getTime();
	opt2.value = formatTimeS;
    temp_form.appendChild(opt2);
	document.body.appendChild(temp_form);
	temp_form.submit();
	document.body.removeChild(tempForm);
